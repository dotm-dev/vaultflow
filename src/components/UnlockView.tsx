...
import { signInWithGoogle, signOutGoogle, getCloudManifest, getCloudVaultData, VaultProfile, GoogleUser, isGoogleConnected, getConnectedGoogleUser } from '../lib/googleDriveSync';
        ...
        <div className="space-y-4">
          <div className="text-center py-2">
            <p className="text-xs text-on-surface-variant leading-relaxed">
              Connect your Google Drive account to list and decrypt your cloud vaults.
            </p>
          </div>
          {cloudError && (
